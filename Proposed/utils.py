...
class ModelTrainer:
    ...
    def train_single_epoch(self):
        ...
        for b, batch in enumerate(self.train_loader):
            ...
            print(torch.arange(len(future_agent_masks)).shape)
            print(torch.arange(len(future_agent_masks)))
            print(future_agent_masks.shape)
            print(future_agent_masks)
            print(three_mask.shape)
            print(three_mask)
            # agent_masks_idx = torch.arange(len(future_agent_masks), device=self.device)[future_agent_masks][three_mask]
            # three_mask.to(device=self.device)
            agent_masks_idx = torch.arange(len(future_agent_masks), device=self.device)[future_agent_masks * three_mask.to(device=self.device)]
